...
(async () => {
    ...
    try {
        ...
        await withSpinner('Verifying the contract..', verifyContractOrClass(network, address, version, license, isAccount, contractName, contract, files))
        console.log(chalk.green('The verification was successful, thank you for using Voyager!'))
    } catch (error) {
